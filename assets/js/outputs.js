    ...
    return new Promise(function(resolve) {
      setTimeout(function() {
        const cardData = [
          ...
          {
            category: ["study"],
            title: "Daniel Ruedt presents the current status of the OpenTYNDP project at the 3rd PyPSA User Meeting",
            date: "2025-07-02",
            author: "Lukas Trippe",
          ...
          {
            category: ["conference"],
            title: "Maximilian Parzen and Harry van der Weijde at IRENA Innovation Week in Bonn",
            date: "2025-06-16",
            author: "Open Energy Transition",
          ...
          {
            category: ["webinar"],
            title: "Tobias Augspurger is speaking at Join Centre for Net Zero's upcoming webinar on <em>Decarbonising Global Energy Systems</em>",
            date: "2025-04-15",
            author: "Open Energy Transition",
