        ...
        setTimeout(function() {
          const cardData = [
            ...
            // category: 'consultancy', 'software development', 'training and capacity building'],
            {
              ...
              date: '2024-09-01',
              client: 'Breakthrough Energy, Google.org, European Climate Foundation',
            ...
            },
            {
              ...
              description: 'In Zambia, 90% of the population lacks access to clean cooking solutions, relying instead \
              on charcoal, which is a major driver of deforestation, carbon emissions, and severe health risks. \
              Addressing this challenge is important for people and the environment. \
              The Energy System Chef Zambia project is designed to explore the transformative potential of large-scale \
              e-cooking adoption. By assessing the energy system implications and developing implementation strategies, \
              this initiative paves the way for a just energy transition. \
              Through comprehensive research, the project evaluates alternative clean cooking fuel solutions, models \
              carbon financing strategies, and assesses the socio-economic impacts of a shift toward sustainable energy. \
              Key stakeholders, including Zambian ministries, USAID, ZESCO, and the Modern Energy Cooking Services \
              Programme, are engaged to drive effective policy and implementation. \
              By promoting research, training, and the development of software tools, the project contributes directly \
              to Zambia’s clean cooking transition. Its outcomes support sustainable energy access, reduce deforestation, \
              improve public health, and foster a resilient, just energy system for future generations.',,
              date: '2023-03-01',
            ...
            },
            {
              ...
              description: 'As of 2023, Kazakhstan’s power mix includes just 5% variable renewables (vRES), with \
              a national goal to reach 15% by 2030. Achieving this requires balancing affordability, supply security, \
              and a transition away from coal-fired power generation. \
              The Kazakhstan project explores ambitious pathways to integrate higher shares of solar and wind \
              energy. By incorporating transmission system infrastructure and advanced energy modeling, it provides a comprehensive \
              approach to energy planning.\
              The project involves model validation, workflow testing, and simulations to assess the impact of increased \
              renewable generation. Results will be visualized for clear interpretation, and the methodology will be \
              thoroughly documented and technically reviewed to ensure reliability.\
              By generating data-driven insights, this project supports informed decision-making, helps surpass renewable \
              energy targets, and accelerates Kazakhstan’s transition to a more sustainable, resilient energy sector.',
              date: '2023-05-01',
