  ...
  <div class="col-lg-4 col-sm-6 mt-3 mb-3 pr-2">
    <div class="blog-item">
      ...
      <div class="blog-content">
        ...
        <div class="blog-meta">
          <div class="blog-meta-element">${blog.date}</div>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 12 12">
            <circle cx="6" cy="6" r="4"/>
            </svg>
          <div class="blog-meta-element">${blog.category}</div>
        </div>
        <div class="blog-text">
          <p>
            ${blog.description}
